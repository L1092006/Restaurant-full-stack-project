...
User=www-data
Group=www-data
WorkingDirectory=/srv/Restaurant/backend/restaurantAPI
EnvironmentFile=/srv/Restaurant/backend/restaurantAPI/restaurantAPI/.env
ExecStart=/srv/Restaurant/backend/restaurantAPI/env/bin/gunicorn restaurantAPI.wsgi:application -c gunicorn.conf.py
